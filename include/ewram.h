...
#define eWallyTurnCounter                      (gSharedMem[0x160A8])
#define eWallyCmd20Counter                      (gSharedMem[0x160A9])
#define eWallyTurnTimer                      (gSharedMem[0x160AA])
#define eWallyCmd20Timer                      (gSharedMem[0x160AB])
