...
enum {
    SCENE_CHANGE_1 = PAGE_PROGRAMMERS_1,
    SCENE_CHANGE_2 = PAGE_POKEMON_GRAHPIC_DESIGNERS_3,
    SCENE_CHANGE_3 = PAGE_GAME_DESIGNERS_2,
    SCENE_CHANGE_4 = PAGE_MAP_DATA_DESIGNERS,
    SCENE_CHANGE_5 = PAGE_SPECIAL_THANKS_1,
    SCENE_CHANGE_6 = PAGE_TASK_MANAGERS,
    SCENE_CHANGE_7 = PAGE_TRANSLATION_COORDINATOR,
    SCENE_CHANGE_8 = PAGE_TEXT_EDITOR,
};
