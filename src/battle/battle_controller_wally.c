...
{
    WallyHandleGetAttributes,          // WallyHandleGetMonData,
    WallyHandlecmd1,                   // WallyHandleGetRawMonData,
    WallyHandleSetAttributes,          // WallyHandleSetMonData,
    WallyHandlecmd3,                   // WallyHandleSetRawMonData,
    WallyHandleLoadPokeSprite,         // WallyHandleLoadMonSprite,
    WallyHandleSendOutPoke,            // WallyHandleSwitchInAnim,
    WallyHandleReturnPokeToBall,       // WallyHandleReturnMonToBall,
    WallyHandleTrainerThrow,           // WallyHandleDrawTrainerPic,
    WallyHandleTrainerSlide,           // WallyHandleTrainerSlide,
    WallyHandleTrainerSlideBack,       // WallyHandleTrainerSlideBack,
    WallyHandlecmd10,                  // WallyHandleFaintAnimation,
    ...
    WallyHandlecmd18,                  // WallyHandleChooseAction,
    WallyHandlecmd19,                  // WallyHandleUnknownYesNoBox,
    WallyHandlecmd20,                  // WallyHandleChooseMove,
    WallyHandleOpenBag,                // WallyHandleChooseItem,
    WallyHandlecmd22,                  // WallyHandleChoosePokemon,
    WallyHandlecmd23,                  // WallyHandleCmd23,
    WallyHandleHealthBarUpdate,        // WallyHandleHealthBarUpdate,
    WallyHandleExpBarUpdate,           // WallyHandleExpUpdate,
    WallyHandleStatusIconUpdate,       // WallyHandleStatusIconUpdate,
    WallyHandleStatusAnimation,        // WallyHandleStatusAnimation,
    WallyHandleStatusXor,              // WallyHandleStatusXor,
    WallyHandlecmd29,                  // WallyHandleDataTransfer,
    WallyHandleDMATransfer,            // WallyHandleDMA3Transfer,
    WallyHandlecmd31,                  // WallyHandlePlayBGM,
    WallyHandlecmd32,                  // WallyHandleCmd32,
    WallyHandlecmd33,                  // WallyHandleTwoReturnValues,
    WallyHandlecmd34,                  // WallyHandleChosenMonReturnValue,
    WallyHandlecmd35,                  // WallyHandleOneReturnValue,
    WallyHandlecmd36,                  // WallyHandleOneReturnValue_Duplicate,
    WallyHandlecmd37,                  // WallyHandleCmd37,
    WallyHandlecmd38,                  // WallyHandleCmd38,
    WallyHandlecmd39,                  // WallyHandleCmd39,
    WallyHandlecmd40,                  // WallyHandleCmd40,
    WallyHandleHitAnimation,           // WallyHandleHitAnimation,
    WallyHandlecmd42,                  // WallyHandleCmd42,
    WallyHandleEffectivenessSound,     // WallyHandlePlaySE,
    WallyHandlecmd44,                  // WallyHandlePlayFanfareOrBGM,
    WallyHandleFaintingCry,            // WallyHandleFaintingCry,
    WallyHandleIntroSlide,             // WallyHandleIntroSlide,
    WallyHandleTrainerBallThrow,       // WallyHandleIntroTrainerBallThrow,
    WallyHandlecmd48,                  // WallyHandleDrawPartyStatusSummary,
    ...
    WallyHandleResetActionMoveSelection, // WallyHandleResetActionMoveSelection,
    WallyHandlecmd55,                  // WallyHandleCmd55,
    WallyHandlecmd56,                  // nullsub_118
};
